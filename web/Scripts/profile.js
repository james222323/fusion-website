...
const achievement_data = [
    ...
    },
    {
        ...
        id: "play_30_minutes",
        reward: "1k xp + \"Certified Pro Gamer\" Title",
        progress: null,
    ...
    },
    {
        ...
        id: "play_60_minutes",
        reward: "2k xp + \"bro im dead 💀\" Title",
        progress: null,
    ...
    },
    {
        name: "Reach Level 25",
        id: "reach_level_25",
        reward: "2.5k xp + \"Absolutely Cracked\" Title",
        progress: null,
    ...
    },
    {
        name: "Reach Level 50",
        id: "reach_level_50",
        reward: "5k xp + \"Legit Hacker\" Title",
        progress: null,
    ...
    },
    {
        name: "Reach Level 30",
        id: "silver_rank",
        reward: "3k xp + <img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/silver.png' class='img-emoji2'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 30, xp: 3000, b_id: "2" }
    },
    {
        name: "Reach Level 50",
        id: "gold_rank",
        reward: "5k xp + <img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/gold.png' class='img-emoji2'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 50, xp: 5000, b_id: "3" }
    },
    {
        name: "Reach Level 100",
        id: "platnuim_rank",
        reward: "10k xp + <img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/platnuim.png' class='img-emoji2'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 100, xp: 10000, b_id: "4" }
    },
    {
        name: "Reach Level 150",
        id: "diamond_rank",
        reward: "15k xp + <img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/diamond.png' class='img-emoji2'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 150, xp: 15000, b_id: "5" }
    },
    {
        name: "Reach Level 200",
        id: "amethyst_rank",
        reward: "20k xp + <img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/amethyst.png' class='img-emoji2'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 200, xp: 20000, b_id: "6" }
    },
    {
        name: "Reach Level 300",
        id: "master_rank",
        reward: "30k xp + <img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/master.png' class='img-emoji2'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 300, xp: 30000, b_id: "7" }
    },
    {
        name: "Reach Level 400",
        id: "grandmaster_rank",
        reward: "40k xp + <img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/grandmaster.png' class='img-emoji2'> Rank",
        progress: null,
        progress_info: { a: "reach_level", b: 400, xp: 40000, b_id: "8" }
    },
...
function loadProfile(){
    ...
    if(badges && badges.includes("4")) badgesInclude = badgesInclude + "<img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/platnuim.png' class='img-emoji'>";
    if(badges && badges.includes("5")) badgesInclude = badgesInclude + "<img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/diamond.png' class='img-emoji'>";
    if(badges && badges.includes("6")) badgesInclude = badgesInclude + "<img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/amethyst.png' class='img-emoji-t'>";
    if(badges && badges.includes("7")) badgesInclude = badgesInclude + "<img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/master.png' class='img-emoji-t'>";
    if(badges && badges.includes("8")) badgesInclude = badgesInclude + "<img src='https://cdn.jsdelivr.net/gh/james222323/cdnfs@master/grandmaster.png' class='img-emoji-t2'>";
    ...
    document.getElementById("profileLvlXP").innerHTML = `Level: ${lvl} - XP: ${xp}/${75 * lvl}`

    var games_played = localStorage.getItem("playedGames") || null
    if(!games_played){
        document.getElementById("games_played_text").innerText = `0/163`
        document.getElementById("games_played").setAttribute("stroke-dasharray", "0, 100")
    } else {
        document.getElementById("games_played_text").innerText = `${games_played.split("||").length - 1}/163`
        document.getElementById("games_played").setAttribute("stroke-dasharray", Math.trunc((games_played.split("||").length - 1) / 163 * 100) + ", 100")
    }
...
if(window.location.pathname.includes("games.html") || window.location.pathname.includes("games")){
